...
Menu = { 
   ...
   Player5_KeyMenu = { type = MenuC.type.menu, caption = "Player 5" },
   Player6_KeyMenu = { type = MenuC.type.menu, caption = "Player 6" },
   ...
   Viewports = {    
      ...
      labels = { "single", "split", "4 player", "auto", "6 player" },
      values = { 0, 1, 2, 3, 4 },
   ...
   AcceleratorStatus = {
      type = MenuC.type.list, caption = "Accelerator Status HUD",
      labels = { "off", "on" },
      values = { 0, 1 },
      read = function() return settings.show_accel_status; end,
      store = function(value) settings.show_accel_status = value; end
   },
   TrailKillScoring = {
      type = MenuC.type.list, caption = "Trail Kill Scoring",
      labels = { "off", "on" },
      values = { 0, 1 },
      read = function() return settings.trail_kill_scoring; end,
      store = function(value) settings.trail_kill_scoring = value; end
   },
   SnakeMode = {
      type = MenuC.type.list, caption = "Snake Mode",
      labels = { "off", "on" },
      values = { 0, 1 },
      read = function() return settings.snake_mode; end,
      store = function(value) settings.snake_mode = value; c_resetGame(); end
   },

   TeamMode = {
      type = MenuC.type.list, caption = "Team Mode",
      labels = { "off", "on" },
      values = { 0, 1 },
      read = function() return settings.team_mode; end,
      store = function(value) settings.team_mode = value; c_update_settings_cache(); c_resetGame(); end
   },

   SnakeGrowth = {
      type = MenuC.type.list, caption = "Snake Growth",
      labels = { "low", "medium", "normal", "high" },
      values = { 20.0, 40.0, 80.0, 160.0 },
      read = function() return settings.snake_growth; end,
      store = function(value) settings.snake_growth = value; c_update_settings_cache(); end
   },

   SnakeBugCount = {
      type = MenuC.type.list, caption = "Bug Count",
      labels = { "low", "medium", "normal", "high" },
      values = { 2, 4, 8, 12 },
      read = function() return settings.snake_bug_max_active; end,
      store = function(value) settings.snake_bug_max_active = value; c_update_settings_cache(); end
   },
   ...
   Player5 = {    
      type = MenuC.type.list, caption = "Player 5", 
      labels = { "Human", "Computer", "None" },
      values = { 0, 1, 2 },
      read = function() return settings.ai_player5; end,
      store = function(value) settings.ai_player5 = value; c_resetGame(); end
   },
   Player6 = {    
      type = MenuC.type.list, caption = "Player 6", 
      labels = { "Human", "Computer", "None" },
      values = { 0, 1, 2 },
      read = function() return settings.ai_player6; end,
      store = function(value) settings.ai_player6 = value; c_resetGame(); end
   },
   ...
   Player5_Right = { 
      type = MenuC.type.key, caption = "Turn Right",
      player = 5, event = "right"
   },
   Player5_GlanceLeft = { 
      type = MenuC.type.key, caption = "Glance Left",
      player = 5, event = "glance_left"
	 },
   Player5_GlanceRight = { 
      type = MenuC.type.key, caption = "Glance Right",
      player = 5, event = "glance_right"
   },
   Player5_Booster = { 
      type = MenuC.type.key, caption = "Booster",
      player = 5, event = "boost"
   },
   Player6_Left = { 
      type = MenuC.type.key, caption = "Turn Left",
      player = 6, event = "left"
   ...
   Player6_Right = { 
      type = MenuC.type.key, caption = "Turn Right",
      player = 6, event = "right"
   },
   Player6_GlanceLeft = { 
      type = MenuC.type.key, caption = "Glance Left",
      player = 6, event = "glance_left"
	 },
   Player6_GlanceRight = { 
      type = MenuC.type.key, caption = "Glance Right",
      player = 6, event = "glance_right"
   },
   Player6_Booster = { 
      type = MenuC.type.key, caption = "Booster",
      player = 6, event = "boost"
   },
   ...
   CrashMessages = {
      type = MenuC.type.list, caption = "Crash Messages",
      labels = { "off", "on" },
      values = { 0, 1 },
      read = function() return settings.show_crash_messages; end,
      store = function(value) settings.show_crash_messages = value; c_update_settings_cache(); end
   },
   Scores = {
...
Menu.GameSettingsMenu.items = { "FastFinish", "CameraMode", "Viewports", "Map", "TrailKillScoring", "AcceleratorStatus", "SnakeMode", "SnakeGrowth", "SnakeBugCount", "TeamMode" }
Menu.PlayerConfigMenu.items = { "Player1", "Player2", "Player3", "Player4", "Player5", "Player6" }
Menu.KeyConfigMenu.items = { 
   "Player1_KeyMenu", "Player2_KeyMenu", "Player3_KeyMenu", "Player4_KeyMenu", "Player5_KeyMenu", "Player6_KeyMenu"
}
Menu.JoyConfigMenu.items = { "Joy_Threshold" }
-- Optional per-player joystick binding pages (reuse key binding logic)
Menu.Player5_JoyMenu = { type = MenuC.type.menu, caption = "Player 5 (Joystick)" }
Menu.Player6_JoyMenu = { type = MenuC.type.menu, caption = "Player 6 (Joystick)" }
Menu.Player5_JoyMenu.items = {
   "Player5_Left", "Player5_Right",
   "Player5_GlanceLeft", "Player5_GlanceRight",
   "Player5_Booster",
}
Menu.Player6_JoyMenu.items = {
   "Player6_Left", "Player6_Right",
   "Player6_GlanceLeft", "Player6_GlanceRight",
   "Player6_Booster",
}
Menu.JoyConfigMenu.items = { "Joy_Threshold", "Player5_JoyMenu", "Player6_JoyMenu" }
...
Menu.Player5_KeyMenu.items = { 
   "Player5_Left", "Player5_Right",
   "Player5_GlanceLeft", "Player5_GlanceRight",
   "Player5_Booster",
}
Menu.Player6_KeyMenu.items = { 
   "Player6_Left", "Player6_Right",
   "Player6_GlanceLeft", "Player6_GlanceRight",
   "Player6_Booster",
}
...
Menu.DetailsMenu.items = {
   "Filtering", "AlphaTrails", "Halos",
    -- "Lightcycles",
    "Recognizer", "Lod", 
   "ShadowStyle", "FPS_Counter", "AI_Status", "CrashMessages", "Scores"
}
