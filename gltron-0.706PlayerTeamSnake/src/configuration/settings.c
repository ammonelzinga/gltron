...
void updateSettingsCache(void) {
  ...
  gSettingsCache.trail_kill_scoring = getSettingi("trail_kill_scoring");
  gSettingsCache.show_accel_status = getSettingi("show_accel_status");
  gSettingsCache.show_crash_messages = getSettingi("show_crash_messages");
  gSettingsCache.booster_max = getSettingf("booster_max");
  gSettingsCache.snake_mode = getSettingi("snake_mode");
  gSettingsCache.team_mode = getSettingi("team_mode");
  gSettingsCache.snake_initial_length = getSettingf("snake_initial_length");
  gSettingsCache.snake_growth = getSettingf("snake_growth");
  gSettingsCache.snake_bug_max_active = getSettingi("snake_bug_max_active");
