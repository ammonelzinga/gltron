...
enum { VP_SINGLE = 0, VP_SPLIT = 1, VP_FOURWAY = 2, VP_SIXWAY = 4 }; // Viewport Type; note: 3 reserved for auto
...
extern int vps;
extern int vp_max[];
extern float vp_x[5][6];
extern float vp_y[5][6];
extern float vp_w[5][6];
extern float vp_h[5][6];
